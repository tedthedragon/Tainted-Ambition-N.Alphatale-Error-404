...
class PortableLiteAmp:HDMagAmmo replaces Infrared{
	...
	override void Tick(){
		...
		//this used to be the DoEffect override.
		//however, for whatever reason if you drop
		//multiple items DoEffect would be skipped
		//one tic, causing fov to reset visibly
		//during that time.
