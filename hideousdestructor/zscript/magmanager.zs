...
class MagManager:HDWeapon{
	...
	override void beginplay(){
		super.beginplay();
		uitext=Stringtable.Localize("$MAGMANAGER_UITEXT");
	...
	override string gethelptext(){
		LocalizeHelp();
		return
		LWPHELP_FIRE.."/"..LWPHELP_ALTFIRE..StringTable.Localize("$MAGMWH_FIRE")
		..LWPHELP_ALTRELOAD..StringTable.Localize("$MAGMWH_ALTRELOAD")
		..LWPHELP_RELOAD.."/"..LWPHELP_UNLOAD..StringTable.Localize("$MAGMWH_RELOAD")
		..LWPHELP_FIREMODE.."+"..LWPHELP_FIRE.."/"..LWPHELP_ALTFIRE..StringTable.Localize("$MAGMWH_FMODPFIRE")
		..LWPHELP_FIREMODE.."+"..LWPHELP_RELOAD.."/"..LWPHELP_UNLOAD..StringTable.Localize("$MAGMWH_FMODPRELOAD")
		..LWPHELP_FIREMODE.."+"..LWPHELP_DROP..StringTable.Localize("$MAGMWH_FMODPDROP")
		..LWPHELP_USER3..StringTable.Localize("$MAGMWH_USER3")
		;
	}
...
//		invoker.thismag.LowestToLast();
	...
	void UpdateText(){
		string toui=string.format(
			Stringtable.Localize("$MAGMANAGER_CONTROLS1"),thismag?Stringtable.Localize("$MAGMANAGER_CONTROLS2")..thismag.gettag():Stringtable.Localize("$MAGMANAGER_CONTROLS3")
		);
		if(thismag){
...
class PickupManager:HDWeapon{
	default{
		...
		tag "$TAG_PICKUPMANAGER";
	}
	override string gethelptext(){
		LocalizeHelp();
		return
		LWPHELP_FIRE.."/"..LWPHELP_ALTFIRE..StringTable.Localize("$PIKMWH_FIRE")
		..LWPHELP_FIREMODE.."+"..LWPHELP_UPDOWN..StringTable.Localize("$PIKMWH_FMODPUD")
		..LWPHELP_DROP..StringTable.Localize("$PIKMWH_DROP")
		..LWPHELP_ZOOM.."+"..LWPHELP_UPDOWN..StringTable.Localize("$PIKMWH_ZPUD")
		..LWPHELP_USER3..StringTable.Localize("$PIKMWH_USER3")
		;
	}
	hdpickup thisitem;
	string uitext;
	...
	action void UpdateText(){
		...
		invoker.uitext=string.format(Stringtable.Localize("$PICKUPMANAGER_UITEXT"),thisitem?(
			thisitem.gettag().."\n\cm( "..thisitem.getclassname().." )\n\cx"..thisitem.amount
			..Stringtable.Localize("$PICKUPMANAGER_ONDROP")..invoker.weaponstatus[PMSS_DROPAMT]
		):Stringtable.Localize("$PICKUPMANAGER_NOITEMS"));
	}
	override void DropOneAmmo(int amt){
		if(owner&&thisitem){
