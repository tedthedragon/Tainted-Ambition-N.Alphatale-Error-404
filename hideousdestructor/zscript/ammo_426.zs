...
class FourMilAmmo:HDAmmo{
	default{
		...
		inventory.pickupmessage "$PICKUP_426Round1";
	}
	override string pickupmessage(){
		
		string pms=amount==1?Stringtable.Localize("$PICKUP_426Round1"):Stringtable.Localize("$PICKUP_426Round2");
		pms.appendformat(StringTable.Localize("$4MILNOTE"),StringTable.Localize("$426MAGMSG"));
		return pms;
	}
...
class HD4mMag:HDMagAmmo{
	...
	override string pickupmessage(){
		...
		//the DRM spam is still in English. lmao.
		if(mags[0]<51)pms.appendformat(" %s",StringTable.Localize("$426MAGMSG"));
		return pms;
	}
